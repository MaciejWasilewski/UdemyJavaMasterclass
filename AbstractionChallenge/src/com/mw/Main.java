...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (String s : data) {
            stringList.addItem(new StringItem(s));
        }
        stringList.reset();
...
//        intList.addItem(new IntItem(1));
//        intList.addItem(new IntItem(6));
//        intList.addItem(new IntItem(5));
//        intList.addItem(new IntItem(10));
//        System.out.println("10 first el:");
//        intList.reset();
//        for (int i = 0; i < 10; i++) {
//            System.out.println(intList.next());
//        }
////        System.out.println(intList.fromHead());
